    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-muted/20">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <h1 className="text-4xl font-bold text-green-700 mb-4">Privacy Policy</h1>
          <p className="text-gray-700 mb-10">
            At EmailEducate, your privacy matters. We are committed to keeping your personal 
            information secure, transparent, and confidential.
          </p>

          {/* Information We Collect */}
          <section className="mb-10 bg-green-50 border border-green-200 p-6 rounded-xl">
