...
const integrations = [
  { name: 'WordPress', description: 'CMS + Email Marketing. Transform your website into a customer-ready email engine.', link: 'https://get.brevo.com/4o18rd1h33kd' },
  { name: 'WooCommerce', description: 'Ecommerce + Email Marketing. Sync customer data & recover abandoned carts.', link: 'https://get.brevo.com/4o18rd1h33kd' },
  { name: 'Shopify', description: 'Ecommerce + Automation. Trigger personalized campaigns via Brevo.', link: 'https://get.brevo.com/4o18rd1h33kd' },
  { name: 'BigCommerce', description: 'Scale your store with advanced workflows connected to Brevo.', link: 'https://get.brevo.com/4o18rd1h33kd' },
  { name: 'PandaDoc', description: 'Auto-sync docs & contacts. Faster workflow automation.', link: 'https://get.brevo.com/4o18rd1h33kd' },
  { name: 'HubSpot', description: 'Two-way CRM + Marketing Sync. Connect HubSpot with Brevo for automated contact updates and smarter campaigns.', link: 'https://get.brevo.com/4o18rd1h33kd' },
];
